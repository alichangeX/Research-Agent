...
Die Keyword-Recherche findet **nicht** in diesem Skill statt. Sie läuft automatisiert, sobald Ali/Christoph eine Zeile in Airtable („Blog & Newsletter") auf Status „Ausgewählt" setzen:
